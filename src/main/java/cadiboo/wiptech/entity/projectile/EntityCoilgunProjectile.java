...
public class EntityCoilgunProjectile extends EntityBase implements IProjectile {

	private static final Predicate<Entity> PROJECTILE_TARGETS = Predicates.and(EntitySelectors.NOT_SPECTATING, EntitySelectors.IS_ALIVE, new Predicate<Entity>()
	{
	...
	public EntityCoilgunProjectile.PickupStatus pickupStatus;
	/** The owner of this projectile. */
	public Entity shootingEntity;
	private int ticksInGround;
	private int ticksInAir;
	private double damage;
	/** The amount of knockback a projectile applies when it hits a mob. */
	...
	public EntityCoilgunProjectile(World worldIn)
	{
		...
		this.yTile = -1;
		this.zTile = -1;
		this.pickupStatus = EntityCoilgunProjectile.PickupStatus.DISALLOWED;
		this.damage = 2.0D;
	...
	public EntityCoilgunProjectile(World worldIn, EntityLivingBase shooter)
	{
		...
		{
			this.pickupStatus = EntityCoilgunProjectile.PickupStatus.ALLOWED;
		}
	}
	...
	protected void onHit(RayTraceResult raytraceResultIn)
	{
		...
		if (entity != null)
		{
			...
			else
			{
				...
				{
					if (this.pickupStatus == EntityCoilgunProjectile.PickupStatus.ALLOWED)
					{
						this.entityDropItem(this.getNuggetStack(), 0.1F);
					}
	...
	public void readEntityFromNBT(NBTTagCompound compound)
	{
		...
		{
			this.pickupStatus = EntityCoilgunProjectile.PickupStatus.getByOrdinal(compound.getByte("pickup"));
		}
		else if (compound.hasKey("player", 99))
		{
			this.pickupStatus = compound.getBoolean("player") ? EntityCoilgunProjectile.PickupStatus.ALLOWED : EntityCoilgunProjectile.PickupStatus.DISALLOWED;
		}
	...
	public void onCollideWithPlayer(EntityPlayer entityIn)
	{
		...
		{
			boolean flag = this.pickupStatus == EntityCoilgunProjectile.PickupStatus.ALLOWED || this.pickupStatus == EntityCoilgunProjectile.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

			if (this.pickupStatus == EntityCoilgunProjectile.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getNuggetStack()))
			{
				flag = false;
			}
	...
	protected ItemStack getNuggetStack()
	{
		...
		//return new ItemStack(Items.MAGNETIC_METAL_ROD, 1, this.getRodId());
	}
	...
	public static enum PickupStatus
	{
		...
		public static EntityCoilgunProjectile.PickupStatus getByOrdinal(int ordinal)
		{
