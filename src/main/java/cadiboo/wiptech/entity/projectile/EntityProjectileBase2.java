...
public class EntityProjectileBase2 extends EntityArrow {
	...
	public EntityProjectileBase2.PickupStatus pickupStatus;
	...
	public EntityProjectileBase2(World worldIn, double x, double y, double z)
	{
		this(worldIn);
		this.setPosition(x, y, z);
	}

	public EntityProjectileBase2(World worldIn, EntityLivingBase shooter)
	{
	...
	public static enum PickupStatus
	{
		...
		public static EntityProjectileBase2.PickupStatus getByOrdinal(int ordinal)
		{
