...
public class EntityFerromagneticProjectile2 extends EntityProjectileBase2 {
	...
	public EntityFerromagneticProjectile2(World worldIn)
	{
		super(worldIn);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
		this.pickupStatus = EntityProjectileBase2.PickupStatus.DISALLOWED;
		this.damage = 2.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityFerromagneticProjectile2(World worldIn, double x, double y, double z)
	{
		this(worldIn);
		this.setPosition(x, y, z);
	}

	public EntityFerromagneticProjectile2(World worldIn, EntityLivingBase shooter)
	{
		...
		{
			this.pickupStatus = EntityProjectileBase2.PickupStatus.ALLOWED;
		}
	}
	...
	protected void onHit(RayTraceResult raytraceResultIn)
	{
		...
		if (entity != null)
		{
			...
			else
			{
				...
				{
					if (this.pickupStatus == EntityProjectileBase2.PickupStatus.ALLOWED)
					{
	...
	public void readEntityFromNBT(NBTTagCompound compound)
	{
		...
		{
			this.pickupStatus = EntityProjectileBase2.PickupStatus.getByOrdinal(compound.getByte("pickup"));
		}
		else if (compound.hasKey("player", 99))
		{
			this.pickupStatus = compound.getBoolean("player") ? EntityProjectileBase2.PickupStatus.ALLOWED : EntityProjectileBase2.PickupStatus.DISALLOWED;
		}
	...
	public void onCollideWithPlayer(EntityPlayer entityIn)
	{
		...
		{
			boolean flag = this.pickupStatus == EntityProjectileBase2.PickupStatus.ALLOWED || this.pickupStatus == EntityProjectileBase2.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

			if (this.pickupStatus == EntityProjectileBase2.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getAmmoStack()))
			{
				flag = false;
			}
	...
	public static enum PickupStatus
	{
		...
		public static EntityFerromagneticProjectile2.PickupStatus getByOrdinal(int ordinal)
		{
