...
public class DamageSource extends net.minecraft.util.DamageSource {
	...
	public static net.minecraft.util.DamageSource causeRailgunProjectileDamage(EntityParamagneticProjectile projectile,
	...
	public static net.minecraft.util.DamageSource causeCoilgunProjectileDamage(EntityParamagneticProjectile projectile,
			@Nullable Entity indirectEntityIn) {
		return (new EntityDamageSourceIndirect("coilgunprojectile", projectile, indirectEntityIn)).setProjectile();
	}

	public static net.minecraft.util.DamageSource causePlasmaProjectileDamage(EntityParamagneticProjectile projectile,
			@Nullable Entity indirectEntityIn) {
