...
public final class WIPTechAPI {
	 ...
	 * @param type        the {@link cadiboo.wiptech.util.ModEnums.ModMaterialType type} of the material
	 ...
	 */
	public static ModMaterial addMaterial(final String name, final ModMaterialType type, final ModMaterialProperties properties, final String assetsModId) {

		final Class[] parameterTypes = new Class[] { int.class, ModMaterialType.class, ModMaterialProperties.class, String.class };
		final int enumId = ModMaterial.values().length;

		return EnumHelper.addEnum(ModMaterial.class, name, parameterTypes, enumId, type, properties, assetsModId);
	}
	 ...
	 * @return the new material
	 */
	public static ModMaterial addMaterial(final String name, final ModMaterialType type, final ModMaterialProperties properties) {
