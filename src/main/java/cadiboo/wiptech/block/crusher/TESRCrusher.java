...
public class TESRCrusher extends TileEntitySpecialRenderer<TileEntityCrusher> {
  ...
  public void render_NEW(TileEntityCrusher te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
  {
    ...
    if ((!stackToCrush.isEmpty()) || (!stackCrusherBit.isEmpty()))
    {
      ...
      double blockoffset = 0.0D;
      double itemoffset = 0.0D;
      double blocktranslateoffset = 0.0D;
      double itemtranslateoffset = 0.25D;
      ...
      for (ItemStack stack : stacksToRender)
      {
        ...
        {
        case NORTH: 
          GlStateManager.translate(0.0D, isItem ? itemtranslateoffset : blocktranslateoffset, isItem ? itemoffset : blockoffset); break;
        case WEST: 
          GlStateManager.translate(-(isItem ? itemoffset : blockoffset), isItem ? itemtranslateoffset : blocktranslateoffset, 0.0D); break;
        case UP: 
          GlStateManager.translate(isItem ? itemoffset : blockoffset, isItem ? itemtranslateoffset : blocktranslateoffset, 0.0D); break;
        case SOUTH: 
          GlStateManager.translate(0.0D, isItem ? itemtranslateoffset : blocktranslateoffset, -(isItem ? itemoffset : blockoffset)); break;
