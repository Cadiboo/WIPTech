...
import cadiboo.wiptech.tileentity.TileEntityTurbine_OLD;
...
public class BlockTurbine_OLD extends BlockTileEntity<TileEntityTurbine_OLD> {

	public BlockTurbine_OLD(String name, Material material) {
		super(name, material);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack itemStackIn) {
		...
		if (te instanceof TileEntityTurbine_OLD) {
			if (itemStackIn.hasTagCompound()) {
				int energy = itemStackIn.getTagCompound().getInteger("Energy");
				((TileEntityTurbine_OLD) te).energy.setEnergyStored(energy);
			}
		}
	}
	...
	@Override
	public TileEntityTurbine_OLD createTileEntity(World world, IBlockState state) {
		return new TileEntityTurbine_OLD();
	}

	@Override
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityTurbine_OLD tile = (TileEntityTurbine_OLD) worldIn.getTileEntity(pos);
		if (tile != null) {
	...
	/*
	 * @Override public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos,
	 * IBlockState state) { // TODO Auto-generated method stub
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (!worldIn.isRemote) {
			TileEntityTurbine_OLD tile = getTileEntity(worldIn, pos);
