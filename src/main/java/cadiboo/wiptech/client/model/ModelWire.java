...
public class ModelWire implements IModel {
	...
	public static final ResourceLocation TEXTURE_SHEET = new ResourceLocation(ModReference.ID, "minecraftbyexample:blocks/mbe05_block_3d_web");
	...
	// return all other resources used by this model (not strictly needed for this
	// example because we load all the subcomponent
	...
	// return all the textures used by this model (not strictly needed for this
	// example because we load all the subcomponent
	// models during the bake anyway)
	@Override
