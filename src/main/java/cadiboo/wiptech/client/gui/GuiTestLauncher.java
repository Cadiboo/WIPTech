...
public class GuiTestLauncher extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		// this.mc.getTextureManager().bindTexture( new ResourceLocation( Reference.ID,
		// "textures/gui/container/kitbag.png" ) );
		this.mc.getTextureManager()
				.bindTexture(new ResourceLocation("minecraft", "textures/gui/container/generic_54.png"));
