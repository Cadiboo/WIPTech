...
public class EntityPortableGeneratorRenderer extends Render<EntityPortableGenerator> {
	...
	@Override
	public void doRender(EntityPortableGenerator entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		Vec3d entityPos = ClientUtil.getEntityRenderPos(entity, partialTicks).subtract(entity.posX, entity.posY, entity.posZ);
