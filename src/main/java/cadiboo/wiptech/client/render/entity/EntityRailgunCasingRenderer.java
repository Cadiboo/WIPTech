...
public class EntityRailgunCasingRenderer extends Render<EntityRailgunCasing> {
	...
	@Override
	public void doRender(EntityRailgunCasing entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityRailgunCasing entity) {
