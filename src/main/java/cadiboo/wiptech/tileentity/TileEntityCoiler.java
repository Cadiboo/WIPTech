...
public class TileEntityCoiler extends TileEntity implements ITickable {
	...
	private void windItem() {
		if (inventory.getStackInSlot(0) != null && !inventory.getStackInSlot(1).isEmpty()) {
			...
			/*
			 * ItemStack stack = inventory.getStackInSlot(0); ArrayList resultList =
			 * (ArrayList) Recipes.getCoilResult(inventory.getStackInSlot(1)); if(resultList
			 * !=null) { inventory.insertItem(2, ((ItemStack) resultList.get(1)).copy(),
			 * false); inventory.insertItem(3, ((ItemStack) resultList.get(2)).copy(),
			 * false); inventory.insertItem(4, ((ItemStack) resultList.get(3)).copy(),
			 * false); inventory.insertItem(5, ((ItemStack) resultList.get(4)).copy(),
			 * false); inventory.insertItem(6, ((ItemStack) resultList.get(5)).copy(),
			 * false); inventory.insertItem(7, ((ItemStack) resultList.get(6)).copy(),
			 * false); inventory.extractItem(1, 1, false); } else {
	...
	private boolean canCoil() {
		if (inventory.getStackInSlot(0) != null && !inventory.getStackInSlot(0).isEmpty()) {
			...
			/*
			 * ItemStack stack = inventory.getStackInSlot(0); ArrayList resultsList =
			 * (ArrayList) Recipes.getCoilResult(inventory.getStackInSlot(1));
			 * 
			 * boolean recipeExists = resultsList!=null; if(recipeExists) { boolean slot0 =
			 * !inventory.getStackInSlot(0).isEmpty(); boolean slot1 =
			 * !inventory.getStackInSlot(1).isEmpty(); boolean slot2 =
			 * inventory.getStackInSlot(2).getCount() <
			 * inventory.getStackInSlot(2).getMaxStackSize(); boolean slot3 =
			 * inventory.getStackInSlot(3).getCount() <
			 * inventory.getStackInSlot(3).getMaxStackSize(); boolean slot4 =
			 * inventory.getStackInSlot(4).getCount() <
			 * inventory.getStackInSlot(4).getMaxStackSize(); boolean slot5 =
			 * inventory.getStackInSlot(5).getCount() <
			 * inventory.getStackInSlot(5).getMaxStackSize(); boolean slot6 =
			 * inventory.getStackInSlot(6).getCount() <
			 * inventory.getStackInSlot(6).getMaxStackSize(); boolean slot7 =
			 * inventory.getStackInSlot(7).getCount() <
			 * inventory.getStackInSlot(7).getMaxStackSize();
			 * 
			 * if(slot0 && slot1 && slot2 && slot3 && slot4 && slot5 && slot6 && slot7) {
			 * recipeExists = recipeExists && resultsList.size()>0; if(recipeExists) {
			 * recipeExists = recipeExists && resultsList.get(0)!=null; if(recipeExists) {
			 * slot2 = slot2&& (ItemStack) resultsList.get(1)!=null; slot3 = slot3&&
			 * (ItemStack) resultsList.get(2)!=null; slot4 = slot4&& (ItemStack)
			 * resultsList.get(3)!=null; slot5 = slot5&& (ItemStack)
			 * resultsList.get(4)!=null; slot6 = slot6&& (ItemStack)
			 * resultsList.get(5)!=null; slot7 = slot7&& (ItemStack)
			 * resultsList.get(6)!=null; if(slot0 && slot1 && slot2 && slot3 && slot4 &&
			 * slot5 && slot6 && slot7) { slot2 = slot2&& inventory.insertItem(2,
			 * ((ItemStack) resultsList.get(1)).copy(), true).isEmpty(); slot3 = slot3&&
			 * inventory.insertItem(3, ((ItemStack) resultsList.get(2)).copy(),
			 * true).isEmpty(); slot4 = slot4&& inventory.insertItem(4, ((ItemStack)
			 * resultsList.get(3)).copy(), true).isEmpty(); slot5 = slot5&&
			 * inventory.insertItem(5, ((ItemStack) resultsList.get(4)).copy(),
			 * true).isEmpty(); slot6 = slot6&& inventory.insertItem(6, ((ItemStack)
			 * resultsList.get(5)).copy(), true).isEmpty(); slot7 = slot7&&
			 * inventory.insertItem(7, ((ItemStack) resultsList.get(6)).copy(),
			 * true).isEmpty(); if(slot0 && slot1 && slot2 && slot3 && slot4 && slot5 &&
			 * slot6 && slot7) { return true; } } } } } }
			 */
	...
	public static boolean isWinding(TileEntityCoiler tileEntity) {
		// return ((BlockCoiler)
		// tileEntity.getWorld().getBlockState(tileEntity.getPos()).getBlock()).isCoiling();
